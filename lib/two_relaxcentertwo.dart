...
class TwoRelaxCenterTwo extends StatefulWidget {
  static final String id = "tworelaxcentertwo";
  @override
  _TwoRelaxCenterTwoState createState() => _TwoRelaxCenterTwoState();
}
...
class _TwoRelaxCenterTwoState extends State<TwoRelaxCenterTwo> {
  @override
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text(
                "Othaya is a rehabilitation center here to help you make a difference in your life. We help our clients get back on their feet and conquer the world.",
                style: TextStyle(
                  fontSize: 15,
