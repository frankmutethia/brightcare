...
class OneRelaxCenter extends StatefulWidget {
  static final String id = "onerelaxcenter";
  @override
  _OneRelaxCenterState createState() => _OneRelaxCenterState();
}
...
class _OneRelaxCenterState extends State<OneRelaxCenter> {
  @override
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text(
                "Nyeri is a rehabilitation center here to help you make a difference in your life. We help our clients get back on their feet and conquer the world.",
                style: TextStyle(
                  fontSize: 15,
