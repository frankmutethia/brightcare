...
class OneRelaxCenterOne extends StatefulWidget {
  static final String id = "onerelaxcenteone";
  @override
  _OneRelaxCenterOneState createState() => _OneRelaxCenterOneState();
}
...
class _OneRelaxCenterOneState extends State<OneRelaxCenterOne> {
  @override
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text(
                "Mukurweni is a rehabilitation center here to help you make a difference in your life. We help our clients get back on their feet and conquer the world.",
                style: TextStyle(
                  fontSize: 15,
