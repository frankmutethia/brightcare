...
class RelaxCenterOne extends StatefulWidget {
  static final String id = "relaxcenter";
  @override
  _RelaxCenterOneState createState() => _RelaxCenterOneState();
}
...
class _RelaxCenterOneState extends State<RelaxCenterOne> {
  @override
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text(
                "Kieni is a rehabilitation center here to help you make a difference in your life. We help our clients get back on their feet and conquer the world.",
                style: TextStyle(
                  fontSize: 15,
  ...
  _payment() async {
    await InAppPayments.setSquareApplicationId(
        'sq0idp-kX6Ph1lswQvG32zYw174iQ'); //the key here is for the stripe payment services
