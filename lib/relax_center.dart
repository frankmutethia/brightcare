...
class RelaxCenter extends StatefulWidget {
  ...
  @override
  _RelaxCenterState createState() => _RelaxCenterState();
}
...
class _RelaxCenterState extends State<RelaxCenter> {
  @override
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text(
                "Tetu is a rehabilitation center here to help you make a difference in your life. We help our clients get back on their feet and conquer the world.",
                style: TextStyle(
                  fontSize: 15,
